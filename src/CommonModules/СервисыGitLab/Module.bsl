...
// 	Неопределено, СправочникСсылка.ОбработчикиСобытий - ссылка на элемент справочника обработчиков событий;
...
Функция НайтиОбработчикСобытияПоHTTPЗапросу(Знач HTTPСервисЗапрос) Экспорт
	...
	ОбработчикСобытий = Справочники.ОбработчикиСобытий.НайтиПоСекретномуТокену(СекретныйТокен);
...
Функция ПодготовитьДанныеКОтправке(Знач ИдентификаторWebhook, Знач Параметры)
	...
	Если Параметры.ЭтоРучнойЗапуск Тогда
		КлючЗапроса = РегистрыСведений.ДанныеОбработчиковСобытий.СоздатьКлючЗаписи(Новый Структура("Идентификатор, Ключ", ИдентификаторWebhook, Параметры.КлючЗапросаGitLab));
