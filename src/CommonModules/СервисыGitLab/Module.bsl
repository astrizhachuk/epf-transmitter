	...
	Если ЭтоHTTPСервисОтвет ИЛИ ЭтоHTTPОтвет Тогда
		...
		Если ЭтоHTTPСервисОтвет Тогда
			Если Тип = УровеньЖурналаРегистрации.Информация Тогда
				РаботаСИнтернетСервисами.ДобавитьВТелоОтветаСообщениеСИнформацией(ОтветНаЗапрос, ТекстСообщения);
			Иначе
				РаботаСИнтернетСервисами.ДобавитьВТелоОтветаСообщениеОбОшибке(ОтветНаЗапрос, ТекстСообщения);			
			КонецЕсли;
		КонецЕсли;
