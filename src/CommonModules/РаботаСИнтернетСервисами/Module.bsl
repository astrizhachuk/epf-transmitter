...
// Добавляет сообщение в тело ответа в формате JSON по событиям журнала регистрации. Если событие не передано, то
// добавляется сообщение уровня "Информация" журнала регистрации.
// 
// Параметры:
// 	HTTPСервисОтвет - HTTPСервисОтвет - HTTP-ответ.
