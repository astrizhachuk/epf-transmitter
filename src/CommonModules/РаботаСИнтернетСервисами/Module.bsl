...
Процедура ПреобразоватьТелоHTTPОтветаИзФорматаJSON(Знач HTTPОтвет, Знач ЭтоСоответствие = Ложь, ДанныеТела = Неопределено) Экспорт
	...
	ПреобразоватьПотокJSONВКоллекцию(Поток, ЭтоСоответствие, ДанныеТела);
...
// 	Коллекция - Неопределено, Соответствие, Структура - (исходящий параметр), преобразованные Коллекция
//		из формата JSON в Соответствие или Структуру. 
Процедура ПреобразоватьПотокJSONВКоллекцию(Знач Поток, Знач ЭтоСоответствие, Коллекция = Неопределено) Экспорт
