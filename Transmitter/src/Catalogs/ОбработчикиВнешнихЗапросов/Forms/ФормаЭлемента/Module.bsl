...
Процедура ПриСозданииНаСервере( Отказ, СтандартнаяОбработка )
	...
	ИсточникКлючаЗапросов = Перечисления.ИсточникКлючаЗаписи.ПолученныеЗапросы;
...
Procedure OpenBackgrounds( Command )
	...
	OpenForm( "Справочник.ОбработчикиВнешнихЗапросов.Форма.Backgrounds", Options, ThisObject, , , , , FormWindowOpeningMode.LockOwnerWindow );
...
Procedure ЗагрузитьИсториюСобытий( Command )
	...
	OpenForm( "Справочник.ОбработчикиВнешнихЗапросов.Форма.ОтборИсторииСобытий", , ThisObject, , , , Notify, FormWindowOpeningMode.LockOwnerWindow );
