...
Процедура ПриСозданииНаСервере( Отказ, СтандартнаяОбработка )
	...
	Если ( Параметры.ТолькоРедакторМаршрутов ) Тогда
...
Процедура МаршрутыПользовательскаяСхемаПриИзменении( Элемент )
	...
	ТекущиеДанные = Элементы.Коммиты.ТекущиеДанные; // ДанныеФормыЭлементКоллекции: см. РегистрСведений.ВнешниеЗапросы.Форма.ФормаЗаписи.Маршруты
	// BSLLS:LineLength-on
...
Процедура КоммитыПриАктивизацииСтроки( Элемент )
	...
	// BSLLS:LineLength-off
	ТекущиеДанные = Элемент.ТекущиеДанные; // ДанныеФормыЭлементКоллекции: см. РегистрСведений.ВнешниеЗапросы.Форма.ФормаЗаписи.Маршруты
	// BSLLS:LineLength-on
...
Процедура ЗаполнитьМаршруты( Маршруты, Знач Данные )
	...
	Для Каждого СхемаМаршрута Из ВнешниеЗапросы.ПолучитьСводныеСхемыМаршрутов(Данные) Цикл
		...
		НовыйМаршрут.КраткийИдентификатор = НовыйМаршрут.Идентификатор;
...
//  ТекущиеДанные - ДанныеФормыЭлементКоллекции: см. РегистрСведений.ВнешниеЗапросы.Форма.ФормаЗаписи.Маршруты // BSLLS:LineLength-off
//
&НаКлиенте
...
// 
// Параметры:
//  Маршруты - см. РегистрСведений.ВнешниеЗапросы.Форма.ФормаЗаписи.Маршруты
...
Процедура ОбновитьПользовательскиеСхемы( ТекущийОбъект, Знач Маршруты )
	...
	ТекущийОбъект.Данные = Новый ХранилищеЗначения( НовыеДанные );
