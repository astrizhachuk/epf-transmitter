...
//    * Результат - См. НовыйОтправляемыйФайл, Массив Из См. НовыйОтправляемыйФайл - Результат, к отправке
...
Функция НовыеПараметры() Экспорт
	...
	Параметры.Вставить("Результат", Новый Массив);
...
Функция ПодготовитьЗапрос(Сессия, Метод, URL, ДополнительныеПараметры) Экспорт
	...
	Файлы = ВыбратьЗначение(Неопределено, ДополнительныеПараметры, "Результат", Новый Массив);
