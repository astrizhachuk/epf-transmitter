...
// Поиск элемента справочника по секретному ключу (token). Поиск осуществляется в
// отсортированном по убыванию списке элементов справочника, так как в справочнике нет контроля уникальности ключей;
//
// Параметры:
// 	Token - Строка - секретный ключ (token);
//
// Возвращаемое значение:
// 	СправочникСсылка.ОбработчикиСобытий - ссылка на элемент справочника; если не найден, то - пустая ссылка; 
//
// @UnitTest
//
Функция НайтиПоСекретномуКлючу( Знач Token ) Экспорт
	...
	ПустаяСсылка = Справочники.ОбработчикиСобытий.ПустаяСсылка();
