...
Процедура ПриОткрытии( Отказ )
	...
	ПолученныеЗапросыУстановитьОтбор(Объект.Ссылка);
...
Процедура ПолученныеЗапросыУстановитьОтбор( Знач Ссылка )
	
	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки( ПолученныеЗапросы.Отбор,
															"ОбработчикСобытия",
															ВидСравненияКомпоновкиДанных.Равно,
															Ссылка);
КонецПроцедуры
