...
//
Функция ВосстановитьДанныеЗапроса( Знач ОбработчикСобытия, Знач CommitSHA ) Экспорт
	
	КлючЗаписи = Новый Структура();
	КлючЗаписи.Вставить( "ОбработчикСобытия", ОбработчикСобытия );
	КлючЗаписи.Вставить( "Ключ", CommitSHA );
	
	Возврат ВосстановитьДанные( "ДанныеЗапросов", КлючЗаписи );
...
// * ОписаниеОшибки - Строка - описание ошибки при работе с файлами;
//
Функция ВосстановитьВнешниеФайлы( Знач ОбработчикСобытия, Знач CommitSHA ) Экспорт
	
	КлючЗаписи = Новый Структура();
	КлючЗаписи.Вставить( "ОбработчикСобытия", ОбработчикСобытия );
	КлючЗаписи.Вставить( "Ключ", CommitSHA );
	
	Возврат ВосстановитьДанные( "ВнешниеФайлы", КлючЗаписи );
...
Функция ВосстановитьДанные( Знач РегистрСведений, Знач КлючЗаписи )
