...
Функция ПодготовитьДанныеКОтправке(Знач ИдентификаторWebhook, Знач Параметры)
	...
	Если Параметры.ЭтоРучнойЗапуск Тогда
		...
		ДанныеДляОтправки = ОбработчикиСобытий.ВосстановитьВнешниеФайлы( ИдентификаторWebhook, Параметры.КлючЗапросаGitLab);
	Иначе
		...
		ОбработчикиСобытий.СохранитьДанныеЗапроса(ИдентификаторWebhook, Параметры.КлючЗапросаGitLab, ДанныеТелаЗапроса);
		ОбработчикиСобытий.СохранитьВнешниеФайлы(ИдентификаторWebhook, Параметры.КлючЗапросаGitLab, ДанныеДляОтправки);
	КонецЕсли;
