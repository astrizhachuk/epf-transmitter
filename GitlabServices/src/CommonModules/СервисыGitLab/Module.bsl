...
Функция НастройкиМаршрутизации(Знач ИдентификаторWebhook,
	...
	Для каждого ОписаниеФайла Из ОписаниеНастроек Цикл
		...
		Если СтруктураФайла.Ошибка = Неопределено Тогда
			
			Поток = СтруктураФайла.Данные.ОткрытьПотокДляЧтения();
...
Функция ПолучитьДанныеДляОтправкиССервераGitLab(Знач ИдентификаторWebhook,
	...
	Для каждого ОписаниеФайла Из ПолученныеФайлы Цикл
		...
		Если ОписаниеФайла.ОписаниеОшибки = Неопределено Тогда
			...
			НайденнаяСтрока = ДанныеДляОтправки.Найти(ОписаниеФайла.ИмяФайлаWin1251, "ПолноеИмяФайла");
			Если НайденнаяСтрока <> Неопределено Тогда
				
				НайденнаяСтрока.ИмяФайла = ОписаниеФайла.ИмяФайла;
				НайденнаяСтрока.ДвоичныеДанные = ОписаниеФайла.Данные;
