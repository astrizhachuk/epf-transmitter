...
Процедура ЗагрузитьДанные( Знач ПараметрыСобытия, ДанныеЗапроса, ОтправляемыеДанные )
	...
	ДанныеЗапроса = ОбработчикиСобытий.LoadQueryData( ОбработчикСобытия, CheckoutSHA );
	ЛогироватьРезультатОперации( ПараметрыСобытия, LOAD_QUERY_MESSAGE, ДанныеЗапроса );

	ОтправляемыеДанные = ОбработчикиСобытий.LoadRemoteFiles( ОбработчикСобытия, CheckoutSHA );
...
Процедура СохранитьДанныеЗапроса( Знач ПараметрыСобытия, Знач ДанныеЗапроса )
	...
	Попытка
		...
		ОбработчикиСобытий.SaveQueryData( ОбработчикСобытия, CheckoutSHA, ДанныеЗапроса );
...
Процедура СохранитьВнешниеФайлы( Знач ПараметрыСобытия, Знач ОтправляемыеДанные )
	...
	Попытка
		...
		ОбработчикиСобытий.SaveRemoteFiles( ОбработчикСобытия, CheckoutSHA, ОтправляемыеДанные );
