...
Функция ПолучитьФайлыКОтправкеПоДаннымЗапроса( Знач ОбработчикСобытия, ДанныеЗапроса ) Экспорт
	...
	// TODO	
	ДополнитьОписаниеФайловНастройкамиМаршрутизации( Результат, ДанныеЗапроса, ПараметрыПроекта );
	// TODO	
...
#КонецОбласти
	...
	// TODO
Процедура ДополнитьОписаниеФайловНастройкамиМаршрутизации( ОписаниеФайлов, Знач ДанныеЗапроса, Знач ПараметрыПроекта )
