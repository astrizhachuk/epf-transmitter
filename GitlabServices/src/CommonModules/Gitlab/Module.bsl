...
Функция ПараметрыСоединения( Знач Адрес ) Экспорт
	...
	ТекущиеНастройки = НастройкаСервисов.CurrentSettings();
	
	Результат = Новый Структура();
	Результат.Вставить( "Адрес", Адрес );
	Результат.Вставить( "Token", ТекущиеНастройки.GitLabPersonalAccessToken );
	Результат.Вставить( "Таймаут", ТекущиеНастройки.GitLabTimeout );
