...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты
		...
		.ДобавитьТест("ПолучитьДанныеЗаполненияКорректноОбрабатываетСписокДобавленныхФайлов")
		.ДобавитьТест("ПолучитьДанныеЗаполненияКорректноОбрабатываетСписокИзмененныхФайлов")
		.ДобавитьТест("ПолучитьДанныеЗаполненияКорректноРазделяетФайлыПриНаличииОбоихСписков")
			.Тег("component")
...
Процедура ПолучитьПараметрыСоединения() Экспорт
	...
	// when
	Результат = Гитлаб.ПолучитьПараметрыСоединения(Соединение.АдресСервера);
...
Процедура ПолучитьНеобработанныеФайлы(Знач Путь, Знач ИмяФайла, Знач Тело) Экспорт
	...
	ОМ_Тесты.ЮТест().ОжидаетЧто(Результат)
		...
		.Свойство("[0].ИмяФайла").Равно(ИмяФайла)
		.Свойство("[0].RAWFilePath").Равно(Путь)
		.Свойство("[0].ДвоичныеДанные").Равно(Тело);
...
Процедура ПолучитьДанныеЗаполненияКорректноОбрабатываетСписокДобавленныхФайлов() Экспорт
	...
	ОМ_Тесты.ЮТест().ОжидаетЧто(Результат)
		.ИмеетТип("Структура")
		.Свойство("ТипИсточника").Равно(Перечисления.ИсточникиЗапроса.Гитлаб)
		...
		.Свойство("ИзмененныеФайлы")
			.ИмеетТип("Массив")
			.НеЗаполнено()
		.Свойство("ДобавленныеФайлы")
			.ИмеетТип("Массив")
			.ИмеетДлину(2)
		.Свойство("ДобавленныеФайлы[0]").ИмеетТип("Структура")
		.Свойство("ДобавленныеФайлы[0].Идентификатор").Равно("1b11")
		.Свойство("ДобавленныеФайлы[0].ПутьКФайлу").Равно("new.epf")
		.Свойство("ДобавленныеФайлы[1].Идентификатор").Равно("1b11")
		.Свойство("ДобавленныеФайлы[1].ПутьКФайлу").Равно("another.erf")
		.Свойство("ИзмененныеФайлы")
			.ИмеетТип("Массив")
			.НеЗаполнено();
...
Процедура ПолучитьДанныеЗаполненияКорректноОбрабатываетСписокИзмененныхФайлов() Экспорт
	...
	ОМ_Тесты.ЮТест().ОжидаетЧто(Результат)
		...
		.Свойство("Коммиты[0].Дата")
			.ИмеетТип("Дата")
			.Равно(МестноеВремя(Дата(2020, 07, 21, 09, 23, 30), ЧасовойПоясСеанса()))
		.Свойство("Коммиты[1].Идентификатор").НеРавно("1b11")
		.Свойство("ИзмененныеФайлы")
			.ИмеетТип("Массив")
			.ИмеетДлину(2)
		.Свойство("ИзмененныеФайлы[0]").ИмеетТип("Структура")
		.Свойство("ИзмененныеФайлы[0].Идентификатор").Равно("1b11")
		.Свойство("ИзмененныеФайлы[0].ПутьКФайлу").Равно("1.epf")
		.Свойство("ИзмененныеФайлы[1].Идентификатор").Равно("1b11")
		.Свойство("ИзмененныеФайлы[1].ПутьКФайлу").Равно("2.erf")
		.Свойство("ДобавленныеФайлы")
			.ИмеетТип("Массив")
			.НеЗаполнено();
...
Процедура ПолучитьДанныеЗаполненияКорректноРазделяетФайлыПриНаличииОбоихСписков() Экспорт
	...
	ОМ_Тесты.ЮТест().ОжидаетЧто(Результат)
		.ИмеетТип("Структура")
		// Проверяем добавленные
		.Свойство("ДобавленныеФайлы")
			.ИмеетТип("Массив")
			.ИмеетДлину(1)
		.Свойство("ДобавленныеФайлы[0].Идентификатор").Равно("1b11")
		.Свойство("ДобавленныеФайлы[0].ПутьКФайлу").Равно("added.erf")
		// Проверяем измененные
		.Свойство("ИзмененныеФайлы")
			.ИмеетТип("Массив")
			.ИмеетДлину(1)
		.Свойство("ИзмененныеФайлы[0].Идентификатор").Равно("1b11")
		.Свойство("ИзмененныеФайлы[0].ПутьКФайлу").Равно("modified.epf");
...
Процедура ПолучитьДанныеЗаполненияПриОтсутствииДанныхВФорматеJSONВозвращаетМинимальныйНаборДанных(Знач Параметр) Экспорт
	...
	ОМ_Тесты.ЮТест().ОжидаетЧто(Результат)
		...
		.Свойство("ДобавленныеФайлы").НеЗаполнено()
		.Свойство("ИзмененныеФайлы").НеЗаполнено();
...
Процедура ПолучитьДанныеЗаполненияВозвращаетДатуСобытияПоДатеСоответствующегоКоммита() Экспорт
	...
	ОМ_Тесты.ЮТест().ОжидаетЧто(Результат)
		...
		.Свойство("Дата")
			.ИмеетТип("Дата")
			.Равно(МестноеВремя(Дата(2020, 07, 25, 09, 13, 33), ЧасовойПоясСеанса()));
...
Процедура ОбработатьЗапросСобытияВозвращаетОшибку423ПриОтключенномСервисе() Экспорт
	...
	ОМ_Тесты.ЮТест().ОжидаетЧто(Результат.Причина)
		.Равно(Логи.Сообщения().ОбработкаЗапросовОтключена);
