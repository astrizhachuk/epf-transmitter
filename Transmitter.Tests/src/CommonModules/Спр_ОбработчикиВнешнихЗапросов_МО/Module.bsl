...
Процедура ИсполняемыеСценарии() Экспорт
	...
	ЮТТесты
		.ВТранзакции()
			.ДобавитьТест("ЗаписатьНовогоЭлементаВыбрасываетИсключениеПриСовпаденииАдресаПроекта")
...
Процедура ЗаписатьНовогоЭлементаВыбрасываетИсключениеПриСовпаденииАдресаПроекта() Экспорт
	...
	Обработчик.АдресПроекта = АдресПроекта;
