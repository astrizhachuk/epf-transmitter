...
Сценарий: Загрузка истории событий с выбором по периоду "Сегодня"
	...
	Проверяем что записи истории событий появились
		...
		И таблица "EventsHistory" содержит строки:
			...
			# https://github.com/Pr-Mex/vanessa-automation/issues/1000
			# | 'Информация' | 'Фоновое задание'            | '200'                | 'ОтправкаДанныхПолучателю'           | 'site'             | '[ 1b9949a21e6c897b3dcb4dd510ddb5f893adae2f ]: URL сервиса доставки: http://mock-server:1080/receiver3; файл: Внешняя Обработка 1.epf; сообщение:\n{"type":"info","message":"Успех"}' |
			# | 'Информация' | 'Фоновое задание'            | '200'                | 'ОтправкаДанныхПолучателю'           | 'site'             | '[ 1b9949a21e6c897b3dcb4dd510ddb5f893adae2f ]: URL сервиса доставки: http://mock-server:1080/receiver1; файл: Внешняя Обработка 1.epf; сообщение:\n{"type":"info","message":"Успех"}' |
