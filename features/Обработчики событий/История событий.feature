...
Сценарий: Загрузка истории событий с выбором по периоду "Сегодня"
	...
	Проверяем что записи истории событий появились
		...
		И таблица "EventsHistory" содержит строки:
			...
			| 'Информация' | 'Фоновое задание'            | '200'                | 'ОтправкаДанныхПолучателю'           | 'сайт'             | '[ 1b9949a21e6c897b3dcb4dd510ddb5f893adae2f ]: URL сервиса доставки: http://mock-server:1080/endpoint3; файл: Внешняя Обработка 1.epf; текст ответа:\n{"type":"info","message":"Успех"}' |
			| 'Информация' | 'Фоновое задание'            | '200'                | 'ОтправкаДанныхПолучателю'           | 'сайт'             | '[ 1b9949a21e6c897b3dcb4dd510ddb5f893adae2f ]: URL сервиса доставки: http://mock-server:1080/endpoint1; файл: Внешняя Обработка 1.epf; текст ответа:\n{"type":"info","message":"Успех"}' |
