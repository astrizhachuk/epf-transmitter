...
Сценарий: Я просматриваю сохраненные настройки маршрутизации
	...
	И Я проверяю состояние формы строки "1b9949a21e6c897b3dcb4dd510ddb5f893adae2f" для сохраненного значения текста
	И Я проверяю состояние формы строки "ef886bb4e372250d8212387350f7e139cbe5a1af" для сохраненного значения текста
	И Я проверяю состояние формы строки "968eca170a80a5c825b0808734cb5b109eaedcd3" для сохраненного значения текста
	...
	И таблица "Commits" стала равной:
		...
		| 'ef886bb4e372250d8212387350f7e139cbe5a1af' |
		| '968eca170a80a5c825b0808734cb5b109eaedcd3' |
	И Я проверяю состояние формы строки "2b9949a21e6c897b3dcb4dd510ddb5f893adae2f" для сохраненного значения текста
	И Я проверяю состояние формы строки "ef886bb4e372250d8212387350f7e139cbe5a1af" для сохраненного значения текста
	И Я проверяю состояние формы строки "968eca170a80a5c825b0808734cb5b109eaedcd3" для сохраненного значения текста
	И я закрываю окно 'Настройка маршрутизации'
	И я жду закрытия окна 'Настройка маршрутизации' в течение 2 секунд
...
Сценарий: Я редактирую сохраненные настройки маршрутизации
	...
	Редактируем текст по одной строке в неправильном формате
	...
	Редактируем текст по одной строке в JSON-формате
