...
//	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодключаюTestClientЛогинПароль(Парам01,Парам02,Парам03)","ЯПодключаюTestClientЛогинПароль","Дано Я подключаю TestClient ""Этот клиент"" логин ""Пользователь"" пароль """"","",""); //уже был в C:\w\1c\git\vanessa-automation\features\Libraries\TestClients\step_definitions\РаботаСTestClient.epf
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯДелаюPOSTЗапросНаСДаннымиПоКлючу(Парам01,Парам02,Парам03)","ЯДелаюPOSTЗапросНаСДаннымиПоКлючу","И Я делаю POST запрос на ""$$АдресСервисаИБРаспределителя$$"" с данными ""$$ТелоPOSTЗапросаJSON$$"" по ключу ""$$GitlabToken$$""","","");
//	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ВКомандномИнтерфейсеЯВыбираю(Парам01,Парам02)","ВКомандномИнтерфейсеЯВыбираю","Пусть В командном интерфейсе я выбираю 'Интеграция с GitLab' 'Webhooks'","",""); //уже был в C:\w\1c\git\vanessa-automation\features\Libraries\UITestRunner\step_definitions\РаботаСИнтерфейсом.epf
...
&НаКлиенте
//И Я делаю POST запрос на "$$АдресСервисаИБРаспределителя$$" с данными "$$ТелоPOSTЗапросаJSON$$" по ключу "$$GitlabToken$$"
...
//&НаКлиенте
////Пусть В командном интерфейсе я выбираю 'Интеграция с GitLab' 'Webhooks'
