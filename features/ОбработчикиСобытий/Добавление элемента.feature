...
Функционал: Регистрация нового элемента в справочнике обработчиков событий удаленного репозитория

Как Пользователь
Я хочу иметь возможность добавлять новый элемент в справочник "Обработчики событий" внешнего хранилища по секретному ключу
