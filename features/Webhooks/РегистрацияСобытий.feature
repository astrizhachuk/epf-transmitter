...
Функционал: Управление элементами справочника событий внешнего хранилища
...
Сценарий: Типовые действия с элементами справочника Webhooks
	...
	Добавление элемента
		...
		Если в таблице "Список" количество строк "равно" 0 Тогда
			Тогда Я добавляю новую запись "ТестированиеДобавленияРедактированияУдаления" в справочник событий внешнего хранилища
