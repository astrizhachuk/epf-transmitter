...
Сценарий: Добавление нового элемента справочника "Обработчики внешних запросов"
...
Сценарий: Редактирование элемента справочника "Обработчики внешних запросов"
...
Сценарий: Пометка на удаление элемента справочника "Обработчики внешних запросов"
	Дано Я добавляю обработчик событий "Наименование1" для "example1.com" с ключом "Ключ1"
...
Сценарий: Запрет на дублирование элементов справочника "Обработчики внешних запросов"
	Дано Я добавляю обработчик событий "Наименование1" для "example1.com" с ключом "Ключ1"
