...
Сценарий: Я проверяю что данные запроса и полученные внешние файлы сохранились в информационной базе
	...
	Проверка данных на форме элемента обработчиков событий
		...
		И Я закрываю окно 'Тест обработки запроса фэйк 2 (Обработчики внешних запросов)'

		И я жду закрытия окна 'Тест обработки запроса фэйк 2 (Обработчики внешних запросов) *' в течение 2 секунд
