...
Сценарий: Проверка отображения загруженных файлов
	...
	* Просматриваем данные по второму запросу
		...
		Тогда таблица "Коммиты" стала равной:
			| 'Дата'                | 'Идентификатор (краткий)' | 'Комментарий'                                         |
			| '21.07.2020 9:22:30'  | '3b9949a2'                | 'Merge branch \'feature/update-epf\' into \'master\'' |
			| '21.07.2020 9:21:30'  | 'ef886bb4'                | 'deploy'                                              |
		И таблица 'ФайлыПоИдентификатору' стала равной:
			| 'Имя файла'               | 'Путь к файлу'                                             | 'Действие' |
			| 'Внешняя Обработка 1.epf' | 'Каталог с отчетами и обработками/Внешняя Обработка 1.epf' | 'modified' |
		...
		И таблица 'ФайлыПоИдентификатору' стала равной:
			| 'Имя файла'               | 'Путь к файлу'                                             | 'Действие' |
			| 'Внешняя Обработка 3.epf' | 'Каталог с отчетами и обработками/Внешняя Обработка 3.epf' | 'modified' |
			| 'Внешняя Обработка 4.epf' | 'Каталог с отчетами и обработками/Внешняя Обработка 4.epf' | 'modified' |
