...
// 	Фреймворк - ФреймворкТестирования - Фреймворк тестирования
//
Процедура ВосстановитьДанныеЗапроса(Фреймворк) Экспорт
	...
	МенеджерЗаписи.Записать();
	// when	
	Результат = ОбработчикиСобытий.ВосстановитьДанныеЗапроса( ОбработчикСобытия.Ссылка, "Ключ" );
	// then
...
// 	Фреймворк - ФреймворкТестирования - Фреймворк тестирования
//
Процедура ВосстановитьДанныеЗапросаОтсутствуютДанные(Фреймворк) Экспорт
