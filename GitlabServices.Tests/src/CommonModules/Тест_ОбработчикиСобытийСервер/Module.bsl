...
// 	Фреймворк - ФреймворкТестирования - Фреймворк тестирования
//
Процедура SaveQueryData(Фреймворк) Экспорт
	...
	Данные = "Тест";
	// when	
	ОбработчикиСобытий.SaveQueryData(ОбработчикСобытия.Ссылка, "CheckoutSHA", Данные);
	// then
...
// 	Фреймворк - ФреймворкТестирования - Фреймворк тестирования
//
Процедура SaveQueryDataWriteError(Фреймворк) Экспорт
	...
	// when
	Попытка
		ОбработчикиСобытий.SaveQueryData(Справочники.ОбработчикиСобытий.ПустаяСсылка(), "CheckoutSHA", Данные);
...
// 	Фреймворк - ФреймворкТестирования - Фреймворк тестирования
//
Процедура SaveRemoteFiles(Фреймворк) Экспорт
	...
	Данные = "Тест";
	// when	
	ОбработчикиСобытий.SaveRemoteFiles(ОбработчикСобытия.Ссылка, "CheckoutSHA", Данные);
	// then
...
// 	Фреймворк - ФреймворкТестирования - Фреймворк тестирования
//
Процедура SaveRemoteFilesWriteError(Фреймворк) Экспорт
	...
	// when
	Попытка
		ОбработчикиСобытий.SaveRemoteFiles(Справочники.ОбработчикиСобытий.ПустаяСсылка(), "CheckoutSHA", Данные);
		ВызватьИсключение RAISE_MESSAGE;
	Исключение
		// then
		ИнформацияОбОшибке = ИнформацияОбОшибке();
...
// 	Фреймворк - ФреймворкТестирования - Фреймворк тестирования
//
Процедура LoadRemoteFiles(Фреймворк) Экспорт
	...
	// when	
	Результат = ОбработчикиСобытий.LoadRemoteFiles( ОбработчикСобытия.Ссылка, "CheckoutSHA" );
	// then
...
// 	Фреймворк - ФреймворкТестирования - Фреймворк тестирования
//
Процедура LoadRemoteFilesNoData(Фреймворк) Экспорт
...
// 	Фреймворк - ФреймворкТестирования - Фреймворк тестирования
//
Процедура LoadQueryData(Фреймворк) Экспорт
	...
	// when	
	Результат = ОбработчикиСобытий.LoadQueryData( ОбработчикСобытия.Ссылка, "CheckoutSHA" );
	// then
...
// 	Фреймворк - ФреймворкТестирования - Фреймворк тестирования
//
Процедура LoadQueryDataNoData(Фреймворк) Экспорт
