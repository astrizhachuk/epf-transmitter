...
Процедура FilesByRoutes(Фреймворк) Экспорт
	...
	Фреймворк.ПроверитьРавенство(Результат[2].Routes[0], "http://mock-server:1080/receiver3");
	...
	Фреймворк.ПроверитьРавенство(Результат[3].Routes[0], "http://mock-server:1080/receiver3");
	Фреймворк.ПроверитьРавенство(Результат[3].Routes[1], "http://mock-server:1080/receiver1");
