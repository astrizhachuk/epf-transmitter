...
Процедура ТекстСообщенияСИдентификатором(Фреймворк) Экспорт
	
	// given
	Идентификатор = "Префикс";
	Сообщение = "Текст сообщения.";
	// when
	Результат = Логирование.ИдентифицированноеСообщение(Идентификатор, Сообщение);
	// then
	Фреймворк.ПроверитьРавенство(Результат, СтрШаблон("[ %1 ]: %2", Идентификатор, Сообщение));
