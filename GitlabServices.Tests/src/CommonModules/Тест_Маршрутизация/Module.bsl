...
Процедура РаспределитьОтправляемыеДанныеПоМаршрутам(Фреймворк) Экспорт
	...
	НоваяСтрока.ПолноеИмяФайла = "test1.epf";
	...
	НоваяСтрока = ДанныеДляОтправки.Добавить();
	НоваяСтрока.CommitSHA = "1b9949a21e6c897b3dcb4dd510ddb5f893adae2f";
	НоваяСтрока.ИмяФайла = ".ext-epf.json";
	...
	НоваяСтрока.ПолноеИмяФайла = "test3.epf";
	НоваяСтрока.Операция = "modifed";
	...
	Commit1.Вставить("id", "1b9949a21e6c897b3dcb4dd510ddb5f893adae2f");
	Commit2 = Новый Соответствие;
	Commit2.Вставить("id", "968eca170a80a5c825b0808734cb5b109eaedcd3");
	...
	Фреймворк.ПроверитьРавенство(Результат.Получить("1b9949a21e6c897b3dcb4dd510ddb5f893adae2f"), Неопределено);
	Фреймворк.ПроверитьРавенство(Результат.Получить("968eca170a80a5c825b0808734cb5b109eaedcd3").Получить("Каталог 1/test1.epf").Количество(), 1);
	Фреймворк.ПроверитьРавенство(Результат.Получить("968eca170a80a5c825b0808734cb5b109eaedcd3").Получить("Каталог 1/test1.epf")[0], "http://receiver:8083/api/hs/gitlab");
	Фреймворк.ПроверитьРавенство(Результат.Получить("968eca170a80a5c825b0808734cb5b109eaedcd3").Получить("Каталог 2/test2.epf").Количество(), 2);
	Фреймворк.ПроверитьРавенство(Результат.Получить("968eca170a80a5c825b0808734cb5b109eaedcd3").Получить("Каталог 2/test2.epf")[0], "http://receiver:8083/api/hs/gitlab");
	Фреймворк.ПроверитьРавенство(Результат.Получить("968eca170a80a5c825b0808734cb5b109eaedcd3").Получить("Каталог 2/test2.epf")[1], "http://receiver:8081/api/hs/gitlab");
	Фреймворк.ПроверитьРавенство(Результат.Получить("d38eca1b4dd510ddb6788087348eca170a80a567").Получить("Каталог 1/test1.epf").Количество(), 1);
	Фреймворк.ПроверитьРавенство(Результат.Получить("d38eca1b4dd510ddb6788087348eca170a80a567").Получить("Каталог 1/test1.epf")[0], "http://receiver:8083/api/hs/gitlab");
	Фреймворк.ПроверитьРавенство(Результат.Получить("d38eca1b4dd510ddb6788087348eca170a80a567").Получить("Каталог 2/test2.epf").Количество(), 2);
	Фреймворк.ПроверитьРавенство(Результат.Получить("d38eca1b4dd510ddb6788087348eca170a80a567").Получить("Каталог 2/test2.epf")[0], "http://receiver:8083/api/hs/gitlab");
	Фреймворк.ПроверитьРавенство(Результат.Получить("d38eca1b4dd510ddb6788087348eca170a80a567").Получить("Каталог 2/test2.epf")[1], "http://receiver:8081/api/hs/gitlab");
