...
Процедура РаспределитьОтправляемыеДанныеПоМаршрутам(Фреймворк) Экспорт
	...
	Фреймворк.ПроверитьВхождение(Результат[0].ОписаниеОшибки, "не найден маршрут");
	...
	Фреймворк.ПроверитьРавенство(Результат[2].АдресаДоставки[0], "http://receiver:8083/api/hs/gitlab");
	...
	Фреймворк.ПроверитьРавенство(Результат[3].АдресаДоставки[0], "http://receiver:8083/api/hs/gitlab");
	Фреймворк.ПроверитьРавенство(Результат[3].АдресаДоставки[1], "http://receiver:8081/api/hs/gitlab");
