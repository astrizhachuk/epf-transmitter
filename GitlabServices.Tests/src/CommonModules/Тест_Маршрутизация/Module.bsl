...
Процедура РаспределитьОтправляемыеДанныеПоМаршрутам(Фреймворк) Экспорт
	...
	Фреймворк.ПроверитьВхождение(Результат[0].ОписаниеОшибки, НСтр("ru = 'отсутствуют настройки маршрутизации.';en = 'there are no routing settings.'"));
	...
	Фреймворк.ПроверитьВхождение(Результат[4].ОписаниеОшибки, НСтр("ru = 'не задан маршрут доставки файла';en = 'file delivery route not specified'") );
