...
Процедура РаспределитьОтправляемыеДанныеПоМаршрутам(Фреймворк) Экспорт
	...
	Фреймворк.ПроверитьВхождение(Результат[0].ОписаниеОшибки, ROUTING_SETTINGS_MISSING_MESSAGE);
	...
	Фреймворк.ПроверитьВхождение(Результат[4].ОписаниеОшибки, DELIVERY_ROUTE_MISSING_MESSAGE);
