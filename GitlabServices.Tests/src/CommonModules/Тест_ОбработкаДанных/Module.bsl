...
Процедура ОбработатьДанныеРучнойЗапускНетЗаписанныхДанных(Фреймворк) Экспорт
	...
	Фреймворк.ПроверитьВхождение(ЖурналРегистрацииПредупреждение[0].Комментарий, "[ какой-то коммит... ]: данные запроса не найдены");
	Фреймворк.ПроверитьВхождение(ЖурналРегистрацииПредупреждение[1].Комментарий, "[ какой-то коммит... ]: файлы для отправки не найдены");
...
Процедура ОбработатьДанныеРучнойЗапускЕстьЗаписанныеДанные(Фреймворк) Экспорт
	...
	// then
	Фреймворк.ПроверитьВхождение(ЖурналРегистрацииИнформация[0].Комментарий, "[ какой-то коммит... ]: загрузка ранее сохраненных данных");
	Фреймворк.ПроверитьВхождение(ЖурналРегистрацииИнформация[1].Комментарий, "[ какой-то коммит... ]: данные запроса загружены");
	Фреймворк.ПроверитьВхождение(ЖурналРегистрацииИнформация[2].Комментарий, "[ какой-то коммит... ]: файлы для отправки загружены");
...
Процедура ОбработатьДанныеWebhookУспешнаяПодготовкаДанных(Фреймворк) Экспорт
	...
	// then
	Фреймворк.ПроверитьВхождение(ЖурналРегистрацииИнформация[0].Комментарий, "[ какой-то коммит... ]: данные запроса и полученные с сервера файлы сохранены");
