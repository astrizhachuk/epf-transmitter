...
Процедура НачатьЗапускОбработкиДанных(Фреймворк) Экспорт
	...
	МенеджерЗаписи.Ключ = "0123456789abcdef";
	...
	НоваяСтрока.ПутьКФайлуRAW = "/api/v4/projects/1/repository/files/Каталог 1/test1.epf/raw?ref=0123456789abcdef";
	...
	НоваяСтрока = ОтправляемыеДанные.Добавить();
	НоваяСтрока.ПутьКФайлуRAW = "/api/v4/projects/1/repository/files/Каталог 2/test2.epf/raw?ref=0123456789abcdef";
