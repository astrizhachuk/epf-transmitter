...
//
Procedure МокСерверДоступен(Фреймворк) Экспорт
...
// @unit-test
Procedure AppendCollectionFromStream(Фреймворк) Экспорт
...
Procedure Пауза(Знач Ждать) Экспорт
...
Procedure СправочникиУдалитьВсеДанные( Знач ИменаСправочников ) Экспорт
...
Procedure РегистрыСведенийУдалитьВсеДанные( Знач ИменаРегистровСведений ) Экспорт
