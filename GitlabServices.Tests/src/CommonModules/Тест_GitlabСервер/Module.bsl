...
Процедура ПолучитьФайлыКОтправкеПоДаннымЗапроса(Фреймворк) Экспорт
	...
	// then
	Фреймворк.ПроверитьРавенство(Результат.Количество(), 3);
	Фреймворк.ПроверитьРавенство(Результат[0].ПутьКФайлуRAW, ПутьКФайлуRAW1 + "?raw=" + CommitSHA1);
	...
	Фреймворк.ПроверитьРавенство(Результат[1].ПутьКФайлуRAW, ПутьКФайлуRAW2 + "?raw=" + CommitSHA2);
	Фреймворк.ПроверитьРавенство(Результат[1].CommitSHA, CommitSHA2);
	Фреймворк.ПроверитьРавенство(Результат[1].ИмяФайла, "test3.epf");
	Фреймворк.ПроверитьРавенство(Результат[1].ПолноеИмяФайла, "test3.epf");
	Фреймворк.ПроверитьРавенство(Результат[1].Операция, "modified");
	Фреймворк.ПроверитьРавенство(Результат[1].Дата, Дата(2020,03,16,16,00,15));
	Фреймворк.ПроверитьРавенство(ПолучитьСтрокуИзДвоичныхДанных(Результат[1].ДвоичныеДанные), "some_response_body");
	Фреймворк.ПроверитьРавенство(Результат[1].ОписаниеОшибки, "");
	
	Фреймворк.ПроверитьРавенство(Результат[2].ПутьКФайлуRAW, ПутьКФайлуRAW2 + "?raw=" + CommitSHA2);
	Фреймворк.ПроверитьРавенство(Результат[2].CommitSHA, CommitSHA2);
	Фреймворк.ПроверитьРавенство(Результат[2].ИмяФайла, "test9.epf");
	...
	Фреймворк.ПроверитьРавенство(Результат[2].Дата, Дата(2020,03,16,16,00,15));
	Фреймворк.ПроверитьРавенство(ПолучитьСтрокуИзДвоичныхДанных(Результат[2].ДвоичныеДанные), "");
	Фреймворк.ПроверитьНеРавенство(Результат[2].ОписаниеОшибки, "");
