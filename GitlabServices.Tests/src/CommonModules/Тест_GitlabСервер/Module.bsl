...
Процедура ПолучитьФайлФэйкURL(Фреймворк) Экспорт
	...
	// when
	Результат = Gitlab.GetRemoteFile(ПараметрыСоединения, RAWFilePath);
...
Процедура ПолучитьФайл404NotFound(Фреймворк) Экспорт
	...
	// when
	Результат = Gitlab.GetRemoteFile(ПараметрыСоединения, ФэйкRAWFilePath);
...
Процедура ПолучитьФайлПустой(Фреймворк) Экспорт
	...
	// when
	Результат = Gitlab.GetRemoteFile(ПараметрыСоединения, RAWFilePath + "?ref=" + Commit);
...
Процедура ПолучитьФайлыКОтправкеПоДаннымЗапроса(Фреймворк) Экспорт
	...
	Фреймворк.ПроверитьРавенство(Результат[1].URLFilePath, "test1.epf");
	...
	Фреймворк.ПроверитьРавенство(Результат[0].URLFilePath, "test3.epf");
	...
	Фреймворк.ПроверитьРавенство(Результат[2].URLFilePath, "test9.epf");
	...
	Фреймворк.ПроверитьРавенство(Результат[3].URLFilePath, ".ext-epf.json");
	Фреймворк.ПроверитьРавенство(Результат[4].URLFilePath, ".ext-epf.json");
	Фреймворк.ПроверитьРавенство(Результат[5].URLFilePath, ".ext-epf.json");
...
Процедура ОписаниеФайлов(Фреймворк) Экспорт
	...
	Фреймворк.ПроверитьРавенство(Результат.Колонки.URLFilePath.Имя, "URLFilePath");
...
Процедура ПереченьОперацийНадФайлами(Фреймворк) Экспорт
	...
	// when	
	Результат = GitlabCached.PossibleFileActions();
	// then
