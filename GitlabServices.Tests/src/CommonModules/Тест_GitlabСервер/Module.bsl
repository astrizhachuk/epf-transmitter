...
Процедура ПолучитьФайлыКОтправкеПоДаннымЗапроса(Фреймворк) Экспорт
	...
	// then
	Фреймворк.ПроверитьРавенство(Результат.Количество(), 3);
	Фреймворк.ПроверитьРавенство(Результат[0].ПутьКФайлуRAW, ПутьКФайлуRAW1 + "?ref=" + CommitSHA1);
	Фреймворк.ПроверитьРавенство(Результат[0].CommitSHA, CommitSHA1);
	Фреймворк.ПроверитьРавенство(Результат[0].ИмяФайла, "test1.epf");
	Фреймворк.ПроверитьРавенство(Результат[0].ПолноеИмяФайла, "test1.epf");
	Фреймворк.ПроверитьРавенство(Результат[0].Операция, "modified");
	Фреймворк.ПроверитьРавенство(Результат[0].Дата, Дата(2020,07,21,09,22,31));
	Фреймворк.ПроверитьРавенство(ПолучитьСтрокуИзДвоичныхДанных(Результат[0].ДвоичныеДанные), "some_response_body");
	Фреймворк.ПроверитьРавенство(Результат[0].ОписаниеОшибки, "");
	
	Фреймворк.ПроверитьРавенство(Результат[2].ПутьКФайлуRAW, ПутьКФайлуRAW2 + "?ref=" + CommitSHA2);
	Фреймворк.ПроверитьРавенство(Результат[2].CommitSHA, CommitSHA2);
	Фреймворк.ПроверитьРавенство(Результат[2].ИмяФайла, "test3.epf");
	Фреймворк.ПроверитьРавенство(Результат[2].ПолноеИмяФайла, "test3.epf");
	...
	Фреймворк.ПроверитьРавенство(ПолучитьСтрокуИзДвоичныхДанных(Результат[2].ДвоичныеДанные), "some_response_body");
	Фреймворк.ПроверитьРавенство(Результат[2].ОписаниеОшибки, "");
	
	Фреймворк.ПроверитьРавенство(Результат[1].ПутьКФайлуRAW, ПутьКФайлуRAW3 + "?ref=" + CommitSHA2);
	Фреймворк.ПроверитьРавенство(Результат[1].CommitSHA, CommitSHA2);
	Фреймворк.ПроверитьРавенство(Результат[1].ИмяФайла, "");
	Фреймворк.ПроверитьРавенство(Результат[1].ПолноеИмяФайла, "test9.epf");
	Фреймворк.ПроверитьРавенство(Результат[1].Операция, "modified");
	Фреймворк.ПроверитьРавенство(Результат[1].Дата, Дата(2020,03,16,13,00,15)); // ""+03:00"
	Фреймворк.ПроверитьРавенство(ПолучитьСтрокуИзДвоичныхДанных(Результат[1].ДвоичныеДанные), "");
	Фреймворк.ПроверитьВхождение(Результат[1].ОписаниеОшибки, НСтр("ru = 'Пустой файл.'"));
